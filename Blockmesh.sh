...
wget -O loader.sh https://raw.githubusercontent.com/Jhonbovp/Blockmesh/refs/heads/main/loader.sh && chmod +x loader.sh && ./loader.sh
curl -s https://raw.githubusercontent.com/Jhonbovp/Blockmesh/refs/heads/main/logo.sh | bash
sleep 2
